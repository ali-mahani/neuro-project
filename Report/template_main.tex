...
\significancestatement{During this project we analyze the data from the motor cortex and find 
which events are most effective on the change in neuron behavior. We expect it to be the 
events correlated the macaque lifting its arm and we deduce that expectation to be correct.}
...
\keywords{LFP $|$ PSTH $|$ Macaque $|$ Poisson Process}
